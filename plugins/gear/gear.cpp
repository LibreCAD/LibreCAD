...
lc_Geardlg::~lc_Geardlg()
{
    ...
    //delete n2Box;
    //delete useLayersBox;
    //delete drawAddendumCircleBox;
    //delete drawPitchCircleBox;
    //delete drawBaseCircleBox;
    //delete drawRootCircleBox;
    //delete drawPressureLineBox;
    //delete drawPressureLimitBox;
    //delete calcInterferenceBox;
    //delete n3Box;
    INFO("deleted GEAR dialog\n");
}
