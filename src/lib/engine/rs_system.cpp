...
//    LNG("en_GB",RS2::locLeftToRight, "English")
    ...
    LNG("fr_FR",RS2::locLeftToRight, "French (France)")
    ...
    LNG("de_DE",RS2::locLeftToRight, "German (Germany)")
    ...
    LNG("it_IT",RS2::locLeftToRight, "Italian (Italy)")
    ...
    LNG("kok"     ,RS2::locLeftToRight, "Konkani")
    ...
    LNG("ms_MY",RS2::locLeftToRight, "Malay (Malaysia)")
    LNG("mt_MT",RS2::locLeftToRight, "Maltese (Melta)")
    LNG("mni"     ,RS2::locLeftToRight, "Manipuri")
    LNG("mi"   ,RS2::locLeftToRight, "Maori")
    LNG("mr_IN",RS2::locLeftToRight, "Marathi (India)")
    LNG("mo"   ,RS2::locLeftToRight, "Moldavian")
    LNG("mn"   ,RS2::locLeftToRight, "Mongolian")
    LNG("na"   ,RS2::locLeftToRight, "Nauru")
    LNG("ne_NP",RS2::locLeftToRight, "Nepali (Nepal)")
    ...
    LNG("pl_PL",RS2::locLeftToRight, "Polish (Poland)")
    LNG("pt_PT",RS2::locLeftToRight, "Portuguese (Portugal)")
    LNG("pt_BR",RS2::locLeftToRight, "Portuguese (Brazil)")
    LNG("pa"   ,RS2::locLeftToRight, "Punjabi")
    LNG("qu"   ,RS2::locLeftToRight, "Quechua")
    LNG("rm"   ,RS2::locLeftToRight, "Rhaeto-Romance")
    LNG("ro_RO",RS2::locLeftToRight, "Romanian (Romania)")
    LNG("ru_RU",RS2::locLeftToRight, "Russian (Russia)")
    ...
    LNG("sk_SK",RS2::locLeftToRight, "Slovak (Slovakia)")
    LNG("sl_SI",RS2::locLeftToRight, "Slovenian (Slovenia)")
    LNG("so"   ,RS2::locLeftToRight, "Somali")
    LNG("es_ES",RS2::locLeftToRight, "Spanish (Spain)")
    ...
    LNG("sw_KE",RS2::locLeftToRight, "Swahili (Kenya)")
    LNG("sv_SE",RS2::locLeftToRight, "Swedish (Sweden)")
    LNG("sv_FI",RS2::locLeftToRight, "Swedish (Finland)")
    LNG("tl_PH",RS2::locLeftToRight, "Tagalog (Philippines)")
    ...
    LNG("th_TH",RS2::locLeftToRight, "Thai (Thailand)")
    ...
    LNG("tr_TR",RS2::locLeftToRight, "Turkish (Turkey)")
    ...
    LNG("ca_ES@valencia",RS2::locLeftToRight, "Valencian (Spain)")
    LNG("vi_VN",RS2::locLeftToRight, "Vietnamese (Vietnam)")
