...
/// RVT_PORT added #include <qdatetime.h>
#include <qdatetime.h>
/// RVT_PORT added #include <qimagewriter.h>
 ...
 */
//RVT_PORT void QG_LibraryWidget::updatePreview(QListViewItem* item) {
 ...
 */
//QString QG_LibraryWidget::getItemDir(QListViewItem* item) {
...
// RVT_PORT    QListViewItem* parent = item->parent();
 ...
 *                          (e.g. /home/tux/." XSTR(QC_APPKEY) "/library/mechanical/screws/screw1.dxf)
 */
...
QString QG_LibraryWidget::getPathToPixmap(const QString& dir,
    ...
    // List of all directories that contain part libraries:
    QStringList directoryList = RS_SYSTEM->getDirectoryList("library");
    directoryList.prepend(RS_SYSTEM->getHomeDir() + "/." XSTR(QC_APPKEY) "/library");
    QStringList::Iterator it;
    ...
    */
    ...
    QString d = RS_SYSTEM->getHomeDir() + "/." XSTR(QC_APPKEY) "/library" + dir;
