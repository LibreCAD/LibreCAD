...
public:
    ...
    void retranslateUi(QDialog *QG_DlgInitial)
    {
        ...
        lWelcome->setText(QApplication::translate("QG_DlgInitial", "<font size=\"+1\"><b>Welcome to " XSTR(QC_APPNAME) "</b>\n"
"</font>\n"
"<br>\n"
"Please choose the unit you want to use for new drawings and your preferred language.<br>\n"
"You can changes these settings later in the Options Dialog of " XSTR(QC_APPNAME) ".", 0, QApplication::UnicodeUTF8));
