...
RS_Commands::RS_Commands() {
	...
	//draw circle with point and radius
	{
		...
		//draw circle with point and diameter
		{
			{{"circlecr", QObject::tr("circlediam", "circle with center and diameter")}},
			{{"cc", QObject::tr("cd", "circle with center and diameter")}},
			RS2::ActionDrawCircleDiam
		},
