...
TEST_CASE("RS_Entity: material/plotStyle/shadow round-trip", "[entity_metadata]") {
    RS_Line line(RS_Vector{0., 0., 0.}, RS_Vector{1., 1., 0.});
...
TEST_CASE("RS_Entity: setting sidecars to zero clears them", "[entity_metadata]") {
    RS_Line line(RS_Vector{0., 0., 0.}, RS_Vector{1., 1., 0.});
