...
RS_Vector LC_Wipeout::getNearestEndpoint(const RS_Vector& coord, double* dist) const {
...
RS_Vector LC_Wipeout::getNearestCenter(const RS_Vector& coord, double* dist) const {
    if (data.vertices.empty()) {
...
RS_Vector LC_Wipeout::getNearestDist(double /*distance*/, const RS_Vector& coord,
                                     double* dist) const {
    return getNearestEndpoint(coord, dist);
}

double LC_Wipeout::getDistanceToPoint(const RS_Vector& coord, RS_Entity** entity,
...
void LC_Wipeout::mirror(const RS_Vector& axisPoint1, const RS_Vector& axisPoint2) {
    for (RS_Vector& v : data.vertices) {
