...
class LC_Quadratic;
class DRW_Variant; // fixme - it seems that this is not good depenency as it ties generic entity to format.
/**
...
public:
    ...
    */
    ...
    // fixme - sand - is it a really nice dependency???? DXF&DWG was previously abstracted from entity, and this is
    // explicit depenency now
