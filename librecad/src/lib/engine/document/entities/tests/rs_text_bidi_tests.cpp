 ...
 */
Qt::LayoutDirection resolveBaseDirection(
...
TEST_CASE("RS_Text bidi: visual-order pass reverses Hebrew like MText does",
    ...
    Qt::LayoutDirection base =
        resolveBaseDirection(s, RS_TextData::ByContent);
