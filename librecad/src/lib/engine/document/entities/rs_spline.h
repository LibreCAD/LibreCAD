...
public:
   ...
   * Where the weights are equal, |C'|^2 and C' x C'' are also enclosed from
   * the Bezier coefficients of the products (speedSquaredProduct,
   * crossProduct), which stay tight where C' and C'' are nearly parallel.
