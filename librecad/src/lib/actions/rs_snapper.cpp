...
void RS_Snapper::init() 
{
	...
	pImpData->line_pen = RS_Pen(RS_Color(snap_color), RS2::Width00, RS2::DashLine2);
	pImpData->circle_pen = RS_Pen(RS_Color(snap_color), RS2::Width00, RS2::SolidLine);
	pImpData->circle_pen.setScreenWidth(1);
