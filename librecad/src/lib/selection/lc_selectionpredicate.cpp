...
LC_SelectionPredicate::LC_SelectionPredicate(const RS2::EntityType entityType) {
    if (entityType == RS2::EntityType::EntityUnknown) {
        m_acceptEntityFunction = []([[maybe_unused]]RS_Entity* e)-> bool {return true;};
    }
    else {
        m_acceptEntityFunction = [this](const RS_Entity* e)-> bool {return e->rtti() == m_entityType;};
    }
}
