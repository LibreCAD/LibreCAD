...
void RS_ActionPolylineTrim::init(int status) {
    ...
    delEntity = Segment1 = Segment2 = nullptr;
}
    ...
    if (e->button() == Qt::LeftButton) {
        ...
        case SetSegment2:
            ...
            if (!delEntity) {
                ...
                double dist = graphicView->toGraphDX(snapRange)*0.9;
                Segment2 = (RS_AtomicEntity*)((RS_Polyline*)delEntity)->getNearestEntity(
                            RS_Vector(graphicView->toGraphX(e->x()), graphicView->toGraphY(e->y())), &dist, RS2::ResolveNone);
                if(!Segment2)
                    break;
                deleteSnapper();
                trigger();
