 ...
 */
class LC_ActionModifyDeleteFree:public RS_ActionInterface {
Q_OBJECT
public:
    explicit LC_ActionModifyDeleteFree(LC_ActionContext *actionContext);
    ~LC_ActionModifyDeleteFree() override;
