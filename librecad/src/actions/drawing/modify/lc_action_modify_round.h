 ...
 */
class LC_ActionModifyRound:public LC_UndoableDocumentModificationAction {
    Q_OBJECT
public:
    explicit LC_ActionModifyRound(LC_ActionContext *actionContext);
    ~LC_ActionModifyRound() override;
