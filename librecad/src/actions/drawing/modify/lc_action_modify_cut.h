 ...
 */
class LC_ActionModifyCut : public LC_UndoableDocumentModificationAction {
    Q_OBJECT
public:
    explicit LC_ActionModifyCut(LC_ActionContext *actionContext);
    ~LC_ActionModifyCut() override;
