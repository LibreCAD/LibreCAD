 ...
 */
class LC_ActionModifyBevel : public LC_UndoableDocumentModificationAction {
    Q_OBJECT
public:
    explicit LC_ActionModifyBevel(LC_ActionContext *actionContext);
    ~LC_ActionModifyBevel() override;
