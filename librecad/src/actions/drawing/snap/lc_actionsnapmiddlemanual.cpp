...
LC_ActionSnapMiddleManual::LC_ActionSnapMiddleManual(LC_ActionContext *actionContext, RS_Pen input_currentAppPen): // todo - is copy of pen really necessary there?
