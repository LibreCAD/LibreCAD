 ...
 */
class LC_ActionDrawArcCenterPointParam:public LC_ActionDrawCircleBase {
    Q_OBJECT
public:
    LC_ActionDrawArcCenterPointParam(LC_ActionContext *actionContext,RS2::ActionType actionType);
    ~LC_ActionDrawArcCenterPointParam() override;
    void reset() override;
