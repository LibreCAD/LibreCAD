 ...
 */
class LC_ActionDrawLinePolygonCornerCorner:public LC_ActionDrawPolygonBase {
    Q_OBJECT
public:
    explicit LC_ActionDrawLinePolygonCornerCorner(LC_ActionContext *actionContext);
    ~LC_ActionDrawLinePolygonCornerCorner() override;
protected:
