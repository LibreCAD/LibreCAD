 ...
 *
 */
class LC_ActionDrawLinePolygonCenterTangent : public LC_ActionDrawPolygonBase {
    Q_OBJECT
public:
    explicit LC_ActionDrawLinePolygonCenterTangent(LC_ActionContext *actionContext);
    ~LC_ActionDrawLinePolygonCenterTangent() override;
protected:
