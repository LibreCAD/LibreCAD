 ...
 */
class LC_ActionDrawLinePolygonCenterCorner : public LC_ActionDrawPolygonBase {
Q_OBJECT
public:
    explicit LC_ActionDrawLinePolygonCenterCorner(LC_ActionContext *actionContext);
    ~LC_ActionDrawLinePolygonCenterCorner() override;
protected:
