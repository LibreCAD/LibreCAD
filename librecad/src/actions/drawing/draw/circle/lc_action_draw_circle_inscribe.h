 ...
 * @author Dongxu Li
 */
class LC_ActionDrawCircleInscribe : public LC_ActionDrawCircleBase {
    Q_OBJECT

public:
    explicit LC_ActionDrawCircleInscribe(LC_ActionContext* actionContext);
    ~LC_ActionDrawCircleInscribe() override;
