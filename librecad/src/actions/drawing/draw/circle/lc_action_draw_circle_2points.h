 ...
 */
class LC_ActionDrawCircle2Points : public LC_ActionDrawCircleBase {
    Q_OBJECT
public:
    explicit LC_ActionDrawCircle2Points(LC_ActionContext* actionContext);
    ~LC_ActionDrawCircle2Points() override;
    void reset() override;
    void preparePreview();
