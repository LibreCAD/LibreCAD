 ...
 * @author Dongxu Li
 */
class LC_ActionDrawCircleTangental2Entities1Point : public LC_ActionDrawCircleBase {
    Q_OBJECT
public:
    explicit LC_ActionDrawCircleTangental2Entities1Point(LC_ActionContext* actionContext);
    ~LC_ActionDrawCircleTangental2Entities1Point() override;
