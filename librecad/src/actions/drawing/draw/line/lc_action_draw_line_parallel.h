 ...
 */
class LC_ActionDrawLineParallel:public LC_UndoableDocumentModificationAction {
    Q_OBJECT
public:
    LC_ActionDrawLineParallel(LC_ActionContext *actionContext, RS2::ActionType actionType);
    ~LC_ActionDrawLineParallel() override;
