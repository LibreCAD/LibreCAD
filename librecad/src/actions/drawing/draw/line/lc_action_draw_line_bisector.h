 ...
 */
class LC_ActionDrawLineBisector:public LC_UndoableDocumentModificationAction {
    Q_OBJECT
public:
    explicit LC_ActionDrawLineBisector(LC_ActionContext *actionContext);
    ~LC_ActionDrawLineBisector() override;
