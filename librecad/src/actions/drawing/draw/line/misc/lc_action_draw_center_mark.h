...
class LC_ActionDrawCenterMark:public LC_AbstractActionWithPreview {
Q_OBJECT
public:
    explicit LC_ActionDrawCenterMark(LC_ActionContext *actionContext);
    ~LC_ActionDrawCenterMark() override;
