 ...
 */
class LC_ActionDrawLineParallelThrough:public LC_UndoableDocumentModificationAction {
    Q_OBJECT
public:
    explicit LC_ActionDrawLineParallelThrough(LC_ActionContext *actionContext);
    ~LC_ActionDrawLineParallelThrough() override;
    ...
    bool isDistributeWithin() const {return m_distributeWithin;}
    void setDistributeWithin(bool val) {m_distributeWithin = val;}
protected:
    enum Status {
        ...
        SetSymmetric,     /**< Setting number in the command line. */
        SetWithin,
    };
