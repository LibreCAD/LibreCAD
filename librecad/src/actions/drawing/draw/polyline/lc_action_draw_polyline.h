...
*/
class LC_ActionDrawPolyline : public LC_UndoableDocumentModificationAction {
    Q_OBJECT
public:
    enum SegmentMode {
        Line = 0,
        Tangential = 1,
        TangentalArcFixedRadius = 2,
        TangentalArcFixedAngle = 3,
        ArcFixedAngle = 4
        // TanRadAng,
        // RadAngEndp,
        // RadAngCenp
...
protected:
   ...
   */
    ...
    LC_ActionDrawPolyline(const QString& name, LC_ActionContext *actionContext, RS2::ActionType actionType);
