 ...
 */
class LC_ActionPolylineDeleteNodeBetween:public LC_ActionPolylineDeleteBase {
    Q_OBJECT
public:
    explicit LC_ActionPolylineDeleteNodeBetween(LC_ActionContext *actionContext);
    ~LC_ActionPolylineDeleteNodeBetween() override;
