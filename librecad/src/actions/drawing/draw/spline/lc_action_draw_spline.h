 ...
 */
class LC_ActionDrawSpline : public LC_SingleEntityCreationAction {
    Q_OBJECT
public:
    explicit LC_ActionDrawSpline(LC_ActionContext *actionContext);
    ~LC_ActionDrawSpline() override;
    void reset() const;
...
protected:
    ...
    LC_ActionDrawSpline(const QString& actionName, LC_ActionContext* actionContext, RS2::ActionType actionType);
