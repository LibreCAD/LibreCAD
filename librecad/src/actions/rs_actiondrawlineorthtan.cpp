...
namespace{
auto g_circleList=EntityTypeList{RS2::EntityArc, RS2::EntityCircle, RS2::EntityEllipse, RS2::EntityParabola, RS2::EntityHyperbola}; //this holds a list of entity types which supports tangent
}
