 ...
 */
class LC_PropertiesEditingWidgetHyperbola : public LC_EntityPropertiesEditorWidget {
    Q_OBJECT

public:
    explicit LC_PropertiesEditingWidgetHyperbola(QWidget *parent = nullptr);
    ~LC_PropertiesEditingWidgetHyperbola() override;
