...
#include "rs_circle.h"
#include "ui_lc_propertieseditingwidget_circle.h"

LC_PropertiesEditingWidgetCircle::LC_PropertiesEditingWidgetCircle(QWidget* parent)
    ...
    connect(ui->leCenterX, &QLineEdit::editingFinished, this, &LC_PropertiesEditingWidgetCircle::onCenterEditingFinished);
    connect(ui->leCenterY, &QLineEdit::editingFinished, this, &LC_PropertiesEditingWidgetCircle::onCenterEditingFinished);
    connect(ui->leRadius, &QLineEdit::editingFinished, this, &LC_PropertiesEditingWidgetCircle::onRadiusEditingFinished);
    connect(ui->leDiameter, &QLineEdit::editingFinished, this, &LC_PropertiesEditingWidgetCircle::onDiameterEditingFinished);
    connect(ui->leRadius, &QLineEdit::textChanged, this, &LC_PropertiesEditingWidgetCircle::onRadiusTextChanged);
    connect(ui->leDiameter, &QLineEdit::textChanged, this, &LC_PropertiesEditingWidgetCircle::onDiameterTextChanged);
}

LC_PropertiesEditingWidgetCircle::~LC_PropertiesEditingWidgetCircle(){
    delete ui;
}

void LC_PropertiesEditingWidgetCircle::setEntity(RS_Entity* entity) {
...
void LC_PropertiesEditingWidgetCircle::onCenterEditingFinished() const {
    m_entity->setCenter(toWCS(ui->leCenterX, ui->leCenterY, m_entity->getCenter()));
}

void LC_PropertiesEditingWidgetCircle::onRadiusEditingFinished() const {
    const double newRadius = toWCSValue(ui->leRadius, m_entity->getRadius());
...
void LC_PropertiesEditingWidgetCircle::onDiameterEditingFinished() const {
    const double newDiameter = toWCSValue(ui->leDiameter, m_entity->getRadius() * 2);
...
void LC_PropertiesEditingWidgetCircle::setupInteractiveInputWidgets() {
