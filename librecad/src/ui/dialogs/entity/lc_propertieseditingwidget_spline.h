 ...
 */
class LC_PropertiesEditingWidgetSpline : public LC_EntityPropertiesEditorWidget {
    Q_OBJECT
public:
    /**
     ...
     */
    explicit LC_PropertiesEditingWidgetSpline(QWidget* parent = nullptr);

    /**
     * @brief Destroys the widget and its UI resources.
     */
    ~LC_PropertiesEditingWidgetSpline() override;
