...
class LC_PropertiesEditingWidgetEllipse : public LC_EntityPropertiesEditorWidget{
    Q_OBJECT
public:
    explicit LC_PropertiesEditingWidgetEllipse(QWidget *parent = nullptr);
    ~LC_PropertiesEditingWidgetEllipse() override;
