...
class LC_PropertiesEditingWidgetPoint : public LC_EntityPropertiesEditorWidget{
    Q_OBJECT
public:
    explicit LC_PropertiesEditingWidgetPoint(QWidget *parent = nullptr);
    ~LC_PropertiesEditingWidgetPoint() override;
