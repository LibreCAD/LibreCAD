...
#ifndef LC_INSERTPROPERTIESEDITINGWIDGET_H
#define LC_INSERTPROPERTIESEDITINGWIDGET_H
...
class LC_PropertiesEditingWidgetInsert : public LC_EntityPropertiesEditorWidget{
    Q_OBJECT
public:
    explicit LC_PropertiesEditingWidgetInsert(QWidget *parent = nullptr);
    ~LC_PropertiesEditingWidgetInsert() override;
...
private:
    Ui::LC_InsertPropertiesEditingWidget *ui;
