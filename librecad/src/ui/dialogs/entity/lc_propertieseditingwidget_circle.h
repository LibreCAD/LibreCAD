...
class LC_PropertiesEditingWidgetCircle : public LC_EntityPropertiesEditorWidget {
    Q_OBJECT
public:
    explicit LC_PropertiesEditingWidgetCircle(QWidget* parent = nullptr);
    ~LC_PropertiesEditingWidgetCircle() override;
