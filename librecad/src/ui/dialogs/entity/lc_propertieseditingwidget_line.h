...
class LC_PropertiesEditingWidgetLine : public LC_EntityPropertiesEditorWidget {
    Q_OBJECT
public:
    explicit LC_PropertiesEditingWidgetLine(QWidget *parent = nullptr);
    ~LC_PropertiesEditingWidgetLine() override;
