...
class LC_PropertiesEditingWidgetArc : public LC_EntityPropertiesEditorWidget {
    Q_OBJECT
public:
    explicit LC_PropertiesEditingWidgetArc(QWidget* parent = nullptr);
    ~LC_PropertiesEditingWidgetArc() override;
...
protected slots:
    ...
    void onArcLengthEditingFinished() const;
    void onSweepAngleEditingFinished() const;
    void onBulgeEditingFinished() const;
