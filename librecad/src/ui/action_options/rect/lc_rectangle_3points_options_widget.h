...
namespace Ui {
    class LC_Rectangle3PointsOptionsWidget;
}

class LC_Rectangle3PointsOptionsWidget : public LC_ActionOptionsWidget {
    Q_OBJECT public:
    explicit LC_Rectangle3PointsOptionsWidget();
    ~LC_Rectangle3PointsOptionsWidget() override;
...
protected:
    ...
    Ui::LC_Rectangle3PointsOptionsWidget* ui;
