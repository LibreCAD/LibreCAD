...
#ifndef LC_LINEPARALLELOPTIONSFILLER_H
#define LC_LINEPARALLELOPTIONSFILLER_H

#include "lc_action_options_properties_filler_base.h"

class LC_LineParallelOptionsFiller : public LC_ActionOptionsPropertiesFillerBase{
    Q_OBJECT
public:
