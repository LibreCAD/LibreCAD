...
protected:
    ...
    void setupLengthType(bool angleIsNotFixed) const;
public slots:
...
private:
    std::unique_ptr<Ui::LC_LineAngleOptionsWidget> ui;
    LC_ActionDrawLineAngle *m_action = nullptr;
    ...
    void setLengthTypeToActionAndView(LC_ActionDrawLineAngle::LengthType lenType);
};
