...
namespace Ui {
    class LC_UCSCreateOptionsWidget;
}

class LC_UCSCreateOptionsWidget : public LC_ActionOptionsWidget{
    Q_OBJECT
public:
    explicit LC_UCSCreateOptionsWidget();
    ~LC_UCSCreateOptionsWidget() override;
public slots:
...
private:
    Ui::LC_UCSCreateOptionsWidget *ui;
