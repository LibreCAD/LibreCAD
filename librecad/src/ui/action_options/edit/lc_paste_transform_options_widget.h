...
namespace Ui {
    class LC_PasteTransformOptionsWidget;
}

class LC_ActionEditPasteTransform;

class LC_PasteTransformOptionsWidget : public LC_ActionOptionsWidget {
    Q_OBJECT public:
    explicit LC_PasteTransformOptionsWidget();
    ~LC_PasteTransformOptionsWidget() override;
...
private:
    Ui::LC_PasteTransformOptionsWidget* ui;
