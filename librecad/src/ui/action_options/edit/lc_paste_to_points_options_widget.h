...
namespace Ui {
    class LC_PasteToPointsOptionsWidget;
}

class LC_PasteToPointsOptionsWidget :public LC_ActionOptionsWidget{
    Q_OBJECT
public:
    explicit LC_PasteToPointsOptionsWidget();
    ~LC_PasteToPointsOptionsWidget() override;
protected slots:
...
private:
    Ui::LC_PasteToPointsOptionsWidget *ui;
