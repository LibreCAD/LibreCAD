...
namespace Ui {
    class LC_SplineExplodeOptionsWidget;
}

class LC_SplineExplodeOptionsWidget : public LC_ActionOptionsWidget{
    Q_OBJECT
public:
    explicit LC_SplineExplodeOptionsWidget();
    ~LC_SplineExplodeOptionsWidget() override;
public slots:
...
protected:
    Ui::LC_SplineExplodeOptionsWidget *ui;
