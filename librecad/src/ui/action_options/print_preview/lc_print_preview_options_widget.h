...
class LC_PrintPreviewOptionsWidget : public LC_ActionOptionsWidget{
    Q_OBJECT
public:
    LC_PrintPreviewOptionsWidget();

    ~LC_PrintPreviewOptionsWidget() override;
...
public slots:
    ...
    void onScaleIndexChanged(int index);
...
private:
    ...
    std::unique_ptr<Ui::LC_PrintPreviewOptionsWidget> ui;
