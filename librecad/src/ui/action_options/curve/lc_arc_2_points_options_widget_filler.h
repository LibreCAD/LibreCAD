...
class LC_Arc2PointsOptionsWidgetFiller : public LC_ActionOptionsPropertiesFillerBase{
    Q_OBJECT
public:
    LC_Arc2PointsOptionsWidgetFiller() = default;
    ~LC_Arc2PointsOptionsWidgetFiller() override = default;
