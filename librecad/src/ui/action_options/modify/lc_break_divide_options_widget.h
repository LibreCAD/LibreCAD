...
namespace Ui {
    class LC_BreakDivideOptionsWidget;
}

class LC_BreakDivideOptionsWidget :public LC_ActionOptionsWidget{
    Q_OBJECT
public:
    explicit LC_BreakDivideOptionsWidget();
protected slots:
...
private:
    Ui::LC_BreakDivideOptionsWidget *ui = nullptr;
