...
namespace Ui {
    class LC_AlignRefOptionsWidget;
}

class LC_AlignRefOptionsWidget : public LC_ActionOptionsWidget{
    Q_OBJECT
public:
    explicit LC_AlignRefOptionsWidget();
    ~LC_AlignRefOptionsWidget() override;
protected slots:
...
private:
    Ui::LC_AlignRefOptionsWidget *ui;
