...
namespace Ui {
    class LC_PointsLatticeOptionsWidget;
}

class LC_PointsLatticeOptionsWidget : public LC_ActionOptionsWidget{
    Q_OBJECT
public:
    explicit LC_PointsLatticeOptionsWidget();
    ~LC_PointsLatticeOptionsWidget() override;
protected:
