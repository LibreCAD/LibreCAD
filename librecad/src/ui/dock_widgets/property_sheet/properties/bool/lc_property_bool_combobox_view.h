...
#ifndef LC_PROPERTYBOOLCOMBOBOXVIEW_H
#define LC_PROPERTYBOOLCOMBOBOXVIEW_H

#include "lc_property_bool.h"
#include "lc_property_view_typed.h"

class LC_PropertyBoolComboBoxView : public LC_PropertyViewTyped<LC_PropertyBool> {
    Q_DISABLE_COPY(LC_PropertyBoolComboBoxView)
