...
#ifndef LC_PROPERTYBOOLCHECKBOXVIEW_H
#define LC_PROPERTYBOOLCHECKBOXVIEW_H

#include "lc_property_bool.h"
#include "lc_property_view_typed.h"

class LC_PropertyBoolCheckBoxView : public LC_PropertyViewTyped<LC_PropertyBool, LC_PropertyViewWithValue> {
