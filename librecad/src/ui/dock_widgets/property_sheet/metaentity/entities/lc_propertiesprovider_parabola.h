...
#ifndef LC_PROPERTIESPROVIDERPARABOLA_H
#define LC_PROPERTIESPROVIDERPARABOLA_H

#include "lc_entity_type_propertiesprovider.h"

class LC_PropertiesProviderParabola : public LC_EntityTypePropertiesProvider {
    Q_OBJECT

public:
    LC_PropertiesProviderParabola(LC_ActionContext* actionContext, LC_PropertySheetWidget* widget)
        : LC_EntityTypePropertiesProvider(RS2::EntityParabola, actionContext, widget) {
    }
