...
#ifndef LC_PROPERTIESPROVIDERMTEXT_H
#define LC_PROPERTIESPROVIDERMTEXT_H

#include "lc_entity_type_propertiesprovider.h"

class LC_PropertiesProviderMText : public LC_EntityTypePropertiesProvider {
    Q_OBJECT

public:
    LC_PropertiesProviderMText(LC_ActionContext* actionContext, LC_PropertySheetWidget* widget)
        : LC_EntityTypePropertiesProvider(RS2::EntityMText, actionContext, widget) {
    }
