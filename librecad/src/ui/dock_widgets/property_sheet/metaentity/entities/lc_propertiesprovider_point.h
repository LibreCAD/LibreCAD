...
#ifndef LC_PROPERTIESPROVIDERPOINT_H
#define LC_PROPERTIESPROVIDERPOINT_H

#include "lc_entity_type_propertiesprovider.h"

class LC_PropertiesProviderPoint : public LC_EntityTypePropertiesProvider {
    Q_OBJECT

public:
    LC_PropertiesProviderPoint(LC_ActionContext* actionContext, LC_PropertySheetWidget* widget)
        : LC_EntityTypePropertiesProvider(RS2::EntityPoint, actionContext, widget) {
    }
