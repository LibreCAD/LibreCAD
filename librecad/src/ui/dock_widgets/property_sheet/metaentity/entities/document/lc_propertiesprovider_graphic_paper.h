...
#ifndef LC_PROPERTIESPROVIDERGRAPHICPAPER_H
#define LC_PROPERTIESPROVIDERGRAPHICPAPER_H

#include "lc_propertiesprovider_graphic_component.h"

class LC_PropertiesProviderGraphicPaper : public LC_PropertiesProviderGraphicComponent {
    Q_OBJECT
public:
    LC_PropertiesProviderGraphicPaper(LC_ActionContext* actionContext, LC_PropertySheetWidget* widget)
        : LC_PropertiesProviderGraphicComponent(actionContext, widget) {
    }
    static const QString SECTION_PAPER;
