...
#ifndef LC_PROPERTIESPROVIDERHATCH_H
#define LC_PROPERTIESPROVIDERHATCH_H

#include "lc_entity_type_propertiesprovider.h"

class LC_PropertiesProviderHatch : public LC_EntityTypePropertiesProvider {
    Q_OBJECT

public:
    LC_PropertiesProviderHatch(LC_ActionContext* actionContext, LC_PropertySheetWidget* widget)
        : LC_EntityTypePropertiesProvider(RS2::EntityHatch, actionContext, widget) {
    }
