...
#ifndef LC_PROPERTIESPROVIDERSPLINEPOINTS_H
#define LC_PROPERTIESPROVIDERSPLINEPOINTS_H

#include "lc_indexed_propertiesprovider_base.h"

class LC_PropertiesProviderSplinePoints : public LC_IndexedPropertiesProviderBase {
    Q_OBJECT

public:
    LC_PropertiesProviderSplinePoints(LC_ActionContext* actionContext, LC_PropertySheetWidget* widget)
        : LC_IndexedPropertiesProviderBase(RS2::EntitySplinePoints, actionContext, widget) {
    }
