...
#ifndef LC_PROPERTIESPROVIDERINSERT_H
#define LC_PROPERTIESPROVIDERINSERT_H

#include "lc_entity_type_propertiesprovider.h"

class LC_PropertiesProviderInsert : public LC_EntityTypePropertiesProvider {
    Q_OBJECT

public:
    LC_PropertiesProviderInsert(LC_ActionContext* actionContext, LC_PropertySheetWidget* widget)
        : LC_EntityTypePropertiesProvider(RS2::EntityInsert, actionContext, widget) {
    }
