...
#ifndef LC_PROPERTIESPROVIDERIMAGE_H
#define LC_PROPERTIESPROVIDERIMAGE_H

#include "lc_entity_type_propertiesprovider.h"

class LC_PropertiesProviderImage : public LC_EntityTypePropertiesProvider {
    Q_OBJECT

public:
    LC_PropertiesProviderImage(LC_ActionContext* actionContext, LC_PropertySheetWidget* widget)
        : LC_EntityTypePropertiesProvider(RS2::EntityImage, actionContext, widget) {
    }
