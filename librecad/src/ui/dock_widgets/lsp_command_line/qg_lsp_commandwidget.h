...
class QG_Lsp_CommandWidget : public QWidget, public Ui::QG_Lsp_CommandWidget
{
    Q_OBJECT

public:
    QG_Lsp_CommandWidget(QWidget *parent = nullptr, const char *name = nullptr, Qt::WindowFlags fl = {});
    ~QG_Lsp_CommandWidget();
    ...
    void setPrompt(const QString& p) { leCommand->setPrompt(p); }
