    ...
    : QSyntaxHighlighter(parent)
{
    ...
    const QString keywordPatterns[] = {
        ...
        QStringLiteral("\\bget_attr\\b"),
        QStringLiteral("\\bget_tile\\b"),
        QStringLiteral("\\bgetangle\\b"),
        QStringLiteral("\\bgetcorner\\b"),
        QStringLiteral("\\bgetdist\\b"),
        QStringLiteral("\\bgetenv\\b"),
        QStringLiteral("\\bgetint\\b"),
        QStringLiteral("\\bgetkword\\b"),
        QStringLiteral("\\bgetorient\\b"),
        ...
        QStringLiteral("\\btext_image\\b"),
        QStringLiteral("\\bthrow\\b"),
        QStringLiteral("\\btime-ms\\b"),
        QStringLiteral("\\btimeout\\b"),
        ...
        QStringLiteral("\\bvector\\b([?])"),
        QStringLiteral("\\bvector_image\\b"),
