...
LC_ActionGroupManager::LC_ActionGroupManager(QC_ApplicationWindow* parent)
    : QObject(parent)
      ...
      , dimension(new LC_ActionGroup(this, tr("Dimension"), tr("Dimensions creation commands"),
                                     ":/icons/dim_horizontal.lci"))
      ...
      , polyline(new LC_ActionGroup(this, tr("Polyline"), tr("Polyline drawing commands"),
                                    ":/icons/polylines_polyline.lci"))
      ...
      , namedViews(
          new LC_ActionGroup(this, tr("Named Views"), tr("Persistent Views operations"), ":/icons/visible.lci"))
