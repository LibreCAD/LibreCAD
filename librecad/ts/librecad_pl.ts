...
Please note that if you'll save pen via editor without restart, current pens from palette will be saved in the new file and therefore existing content of it will be overridden.</source>
   <translation>Lokalizacja pliku pędzli została zmieniona, uruchom ponownie aplikację, aby używać nowego pliku pędzli.
...
Clear filtering mask and repeat.</source>
   <translation>Znaleziono warstwę(i) bez obiektów, a mimo to są one filtrowane i niewidoczne.
...
If No - &quot;By Layer&quot; values remains and so pen of target layer will define pen for such entities.</source>
   <translation>Czy zastąpić wartość „Zgodnie z warstwą” wartościami warstw źródłowych?
