...
Section "Install Section" SecInstall
  ...
  File "${Qt_Dir}\Qt${Qt_Version}\${Qt_Version}\mingw47_32\translations\qtbase_??_??.qm"
  File "${Qt_Dir}\Qt${Qt_Version}\${Qt_Version}\mingw47_32\translations\qtmultimedia_??.qm"
  File "${Qt_Dir}\Qt${Qt_Version}\${Qt_Version}\mingw47_32\translations\qtmultimedia_??_??.qm"
  File "${Qt_Dir}\Qt${Qt_Version}\${Qt_Version}\mingw47_32\translations\qtquick1_??.qm"
  File "${Qt_Dir}\Qt${Qt_Version}\${Qt_Version}\mingw47_32\translations\qtquick1_??_??.qm"
  File "${Qt_Dir}\Qt${Qt_Version}\${Qt_Version}\mingw47_32\translations\qtscript_??.qm"
  File "${Qt_Dir}\Qt${Qt_Version}\${Qt_Version}\mingw47_32\translations\qtscript_??_??.qm"
  File "${Qt_Dir}\Qt${Qt_Version}\${Qt_Version}\mingw47_32\translations\qtxmlpatterns_??.qm"
  File "${Qt_Dir}\Qt${Qt_Version}\${Qt_Version}\mingw47_32\translations\qtxmlpatterns_??_??.qm"
  SetOutPath "$INSTDIR"
